    ...
    <div class="container">
        <div class="card">
            ...
            <div class="info">
                ...
                <div class="buttons"> 
                    <h3>Did you <a class="btn-link btn-link-purple" href="./recovery.php">forget your passoword?</a></h3>
                    <h3>or</h3>
                    <h3>Dont have an account? <a class="btn-link btn-link-purple" href="./signup.php">Sign Up</a></h3>
                </div>
            </div>
        </div>
    </div>
